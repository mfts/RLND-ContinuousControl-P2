...
**Going forward we will work with the second version of 20 identical agents.**
...
2. Place the file in the root of the Github repository's folder (`RLND-ContinuousControl-P2`) , and unzip (or decompress) the file. 

## Instructions

Navigate to `Continuous_Control.ipynb`. You have the options either to
